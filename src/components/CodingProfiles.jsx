...
const CodingProfiles = () => {
  return (
    <section id="profiles" className="min-h-screen flex flex-col justify-center py-20">
      <div className="section-container">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          {profiles.map((p, i) => (
            <motion.a key={i} href={p.url} target="_blank" rel="noopener noreferrer" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.4, delay: i * 0.08 }} className="glass-card-hover p-7 flex flex-col items-center text-center group">
